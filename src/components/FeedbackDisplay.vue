    ...
    <div class="fb-display" style="width: 200px">
      ...
      <div class="feedback-part-noVotes">
        ...
        <div class="feedback-action">
          <div class="btn-edit">
            <button class="btn btn-edit" data-target="#editModal" data-toggle="modal" v-show="isHome">
              <span>
          ...
          <button class="btn btn-delete" data-target="#deleteModal" data-toggle="modal" v-show="isHome">
...
function incrementUpvote() {
  store.incrementUpvote(props.feedback.id)
}
function decrementUpvote() {
  store.decrementUpvote(props.feedback.id)
}
