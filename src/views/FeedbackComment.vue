  ...
  <div class="feedback-comment-main">
    ...
    <div class="feedback-add-comment">
      ...
      <form class="form-form">
        ...
        <div class="form-validation">{{data.error.name}}</div>
        <div class="form-group">
...
data.feedback = {...store.feedbackList[data.feedbackId]};
